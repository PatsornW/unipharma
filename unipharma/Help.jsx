...
function HelpPage({ lang, L, perm = { role: 'admin' } }) {
  ...
  const PAGES = [
    ...
    { icon:'💊', th:'ฐานข้อมูลยา', en:'Drug Database', color:'var(--ok)',
      steps_th:['ค้นหาด้วยรหัส/ชื่อยา กรองตามหมวดหมู่/VAT','ดูรายละเอียด: ต้นทุน/ขาย, กำไร%, หน่วยบรรจุ, สต็อก','เพิ่มยาใหม่ หรือแก้ไข (กำไรแก้ได้→ราคาขายอัปเดต)','📦 Packaging ON เพื่อดูหน่วยบรรจุแบบเต็ม','หน่วยบรรจุแก้ได้ใน Edit form','🏷️ ปุ่ม "จัดการหมวดหมู่": เพิ่ม/แก้ไข/ลบ หมวดหลัก + หมวดย่อย (2 ภาษา) บันทึกแล้วแชร์ขึ้นคลาวด์'],
      steps_en:['Search by code/name, filter by category/VAT','View full details: cost/sell, profit%, packaging, stock','Add new or edit drugs (profit editable → auto-update sell)','Toggle Packaging ON to see packaging hierarchy','Edit packaging in the Edit form','🏷️ "Categories" button: add/edit/delete main & sub-categories (bilingual), saved & shared to the cloud'] },
