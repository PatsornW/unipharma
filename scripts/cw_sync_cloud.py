...
# Fiscal start date: 19/07/2022 — but cap at 2 years rolling so the CW
# BrnSale report does not time out as historical data grows.
_FISCAL_START  = date(2022, 7, 19)
